...
| ディレクトリ | 章タイトル | 外部依存 |
|-------------|-----------|---------|
| `ch01-setup/` | 第1章: Rustの世界へようこそ | なし |
| `ch02-variables/` | 第2章: 変数と型 | なし |
| `ch03-control-flow/` | 第3章: 制御構文 | なし |
...
| `ch09-collections/` | 第9章: コレクション | なし |
...
| `ch16-cli-json-csv-tool/` | 第16章: CLI JSON/CSVツール | clap, serde, csv |
